...
export const indexControllers = {
    ...
    createClient: async(req:Request, res:Response)=>{
        ...
        try {
            const result:any = await connectionSQL.pool.query('INSERT INTO info_paciente (nombre,apellido,cedula,sexo,celular,fecha_nacimiento,ocupacion) VALUES (?,?,?,?,?,?,?)',[newClient.nombre,newClient.apellido,newClient.cedula,newClient.sexo,JSON.stringify(newClient.celular),newClient.fecha_nacimiento,newClient.ocupacion])
    ...
    createBio: async(req:Request, res:Response)=>{
        ...
        try {
            ...
            //CREAR ANTROPOMETRIA
            const result: any = await connectionSQL.pool.query('INSERT INTO _antropometria (id_paciente, peso, talla, cms_perimetro_cintura, cms_perimetro_cadera, cms_perimetro_cuello, contorno_muneca) VALUES (?,?,?,?,?,?,?)',[params, a.peso, a.talla, a.cms_perimetro_cintura, a.cms_perimetro_cadera, a.cms_perimetro_cuello, a.contorno_muneca])


            //CREAR BIOIMPEDANCIA
            const result2: any = await connectionSQL.pool.query('INSERT INTO _bioimpedanciometria (id_paciente, grasa_corporal, masa_muscular, kca_basal, edad_corporal, grasa_visceral) VALUES (?,?,?,?,?,?)',[params, b.grasa_corporal, b.masa_muscular, b.kca_basal, b.edad_corporal, b.grasa_visceral])
